 ...
 * @param {Array} options - Array of options (strings or objects with code/id/name)
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-48 px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm text-left flex items-center justify-between hover:border-gray-400 focus:ring-2 focus:ring-[#0a1833] focus:border-transparent transition"
      >
