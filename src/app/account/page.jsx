                    ...
                    return (
                      ...
                      >
                        <div className="p-5">
                          ...
                          {/* Status timeline */}
                          {!isPending && <OrderStatusTimeline status={order.status} />}

                          {/* View Details link */}
                          <div className="flex justify-end mt-4">
                            <button
                              onClick={() => router.push(`/order-confirmation?order=${order.orderNumber}`)}
                              className="flex items-center gap-1.5 text-sm font-medium text-[#0a1833] hover:underline"
                            >
                              View Details
                              <ArrowRight size={15} />
                            </button>
